...
const ProgressIcon = ({
  ...
  const percentage =
    max === 0 ? 0 : Math.min(Math.round((value / max) * 100), 100)
  ...
  return (
    <div
      className={`flex flex-col mx-auto items-center w-22 h-min cursor-pointer transition-all duration-200 ${isHovered ? 'scale-105' : 'scale-100'}`}
