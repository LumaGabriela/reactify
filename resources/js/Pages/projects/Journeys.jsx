...
const Journeys = ({ project, setProject }) => {
  ...
  const [editingStep, setEditingStep] = useState({ JourneyId: null, stepIndex: null });
  ...
  const [deleteConfirmStep, setDeleteConfirmStep] = useState({ JourneyId: null, stepIndex: null });
  ...
  const addNewJourney = () => {
    ...
    router.post(route('journey.store'), {
              ...
              >
                <div className="flex items-center text-2xl">
                  ...
                  {editingJourney === journey.id ? (
                    ...
                    <h4 className="text-white font-medium m-0">{journey.title}</h4>
                  )}
                </div>
                        ...
                        {journey?.steps.map((step, stepIndex) => {
                          ...
                          return (
                            <div
                              ...
                              <div
                                onClick={() => startEditStep(journey.id, stepIndex)}
                                  ...
                                  <div className="h-full w-full p-2 text-sm bg-gray-700 rounded" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    <div className="flex justify-between mt-1">
                                      ...
                                      <button
                                        ...
                                        onClick={() => confirmDeleteStep(journey.id, stepIndex)}
                                      >
                                        Excluir
                                      </button>
                                    </div>
                              ...
                              {deleteConfirmStep.JourneyId === journey.id && deleteConfirmStep.stepIndex === stepIndex && (
                                <div className="absolute top-16 left-1/2 transform -translate-x-1/2 z-10 bg-gray-700 rounded shadow-lg p-2 w-48">
                                  ...
                                  <div className="flex justify-between gap-1">
                                    ...
                                    <button
                                      ...
                                      onClick={() => setDeleteConfirmStep({ JourneyId: null, stepIndex: null })}
                                    >
                                      Não
                                    </button>
                                  </div>
